...
minetest.register_tool("futureweapons:claw", {
...
minetest.register_tool("futureweapons:pick_zanium", {
...
minetest.register_tool("futureweapons:shovel_zanium", {
...
minetest.register_tool("futureweapons:axe_zanium", {
...
minetest.register_tool("futureweapons:sword_zanium", {
...
minetest.register_craft({
	...
	recipe = {
		{'futureores:crystal_blue', 'futureores:lightsteel_ingot', ''},
...
minetest.register_craft({
	...
	recipe = {
		{'futureores:crystal_red', 'futureores:lightsteel_ingot', ''},
		{'', 'futureores:lightsteel_ingot', ''},
		{'', 'default:steel_ingot', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'futureores:zanium_ingot', 'futureores:zanium_ingot', 'futureores:zanium_ingot'},
		{'', 'default:stick', ''},
		{'', 'default:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'futureores:zanium_ingot', 'futureores:zanium_ingot'},
		{'', 'default:stick', 'futureores:zanium_ingot'},
		{'', 'default:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'futureores:zanium_ingot', 'futureores:zanium_ingot', ''},
		{'futureores:zanium_ingot', 'default:stick', ''},
		{'', 'default:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'futureores:hotium_ingot', 'futureores:hotium_ingot', 'futureores:hotium_ingot'},
		{'', 'default:stick', ''},
		{'', 'default:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'', 'futureores:hotium_ingot', 'futureores:hotium_ingot'},
		{'', 'default:stick', 'futureores:hotium_ingot'},
		{'', 'default:stick', ''},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{'futureores:hotium_ingot', 'futureores:hotium_ingot', ''},
		{'futureores:hotium_ingot', 'default:stick', ''},
		{'', 'default:stick', ''},
	}
})
...
minetest.register_tool("futureweapons:pick_hotium", {
...
minetest.register_tool("futureweapons:shovel_hotium", {
...
minetest.register_tool("futureweapons:axe_hotium", {
...
minetest.register_tool("futureweapons:sword_hotium", {
